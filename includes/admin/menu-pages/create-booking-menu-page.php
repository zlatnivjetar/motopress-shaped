...
class CreateBookingMenuPage extends AbstractMenuPage {
	...
	public function onLoad() {
		...
		switch ( $this->step ) {
			...
			case 3:
				if ( empty( $_POST[ 'mphb_check_in_date' ] ) || empty( $_POST[ 'mphb_check_out_date' ] ) ) {
					// we need to return to the first step if a user refreshes a page
					// because we do not have booking details data anymore
